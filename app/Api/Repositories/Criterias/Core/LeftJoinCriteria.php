...
/**
 * Class LeftJoinCriteria
 * @package Api\Repositories\Criterias\Core
 */
class LeftJoinCriteria extends BaseApiCriteria
{
    /**
     * @var string
     */
    ...
    public function apply($query, RepositoryInterface $repository)
    {
        ...
        return $query->leftJoin($this->table, "$this->table.$this->foreignColumn", "=", "$table.$this->localColumn");
    }
}
